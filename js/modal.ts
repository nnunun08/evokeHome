...
const modal:any = document.querySelector('.detail')
const modalItem = document.querySelectorAll('.detail .item')
const body:any = document.querySelector('body')
const footer:any = document.querySelector('footer')
const mail:any = document.querySelector('.mail')
const leftCon:any = document.querySelectorAll('.home .detail .item .left')
console.log(leftCon)
